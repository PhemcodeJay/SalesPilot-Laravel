          ...
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                ...
                <?php endif; ?>
                <form action="http://localhost:8000/loginpage.php" method="post" class="text-start">
                  ...
                  <p class="mt-4 text-sm text-center">
                    ...
                    <a href="http://localhost:8000/sign-up.php" class="text-primary font-weight-bold">Sign up</a>
                  </p>
                </form>
              </div>
            </div>
